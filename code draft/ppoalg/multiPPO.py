...
class PPO(parl.Algorithm):
    ...
    def learn(self, batch_obs, batch_action, batch_value, batch_return, batch_logprob, batch_adv, hidden_all, lr=None):
        return_value_loss, return_action_loss, return_entropy_loss = [], [], []
        for i in range(self.model.n_clusters):
            values, h = self.model.net[i].value(batch_obs[i], hidden_all)
    ...
    def sample(self, obs, hidden_all):
        ...
        """
        value, new_hidden = self.model.value(obs, hidden_all)
    ...
    def value(self, obs, hidden_all):
        ...
        """
        return self.model.value(obs, hidden_all)
